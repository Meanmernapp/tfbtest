...
const Error505 = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen w-screen px-10">
      ...
      <button
        onClick={goBack}
        className="font-semibold text-xs xsm:text-sm sm:text-base  w-auto text-center mt-2 px-11 py-1.5 lg:py-2.3 text-rose-400 bg-white border border-rose-400 rounded-md hover:text-gray-800 dark:text-white hover:bg-rose-400  active:text-gray-800 dark:text-white active:border-rose-500 active:bg-rose-500 "
      >
        Go back
      </button>
    </div>
